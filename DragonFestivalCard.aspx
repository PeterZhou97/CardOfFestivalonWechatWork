<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DragonFestivalCard.aspx.cs" Inherits="BirthdayCard.DragonFestivalCard" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
    ...
    <style type="text/css">
        #app{
            ...
            background-image:url("media/DragonBoatFestival/5.fw.png")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("media/DragonBoatFestival/1.fw.png", "media/DragonBoatFestival/2.fw.png",
            "media/DragonBoatFestival/3.fw.png", "media/DragonBoatFestival/4.fw.png",
            "media/DragonBoatFestival/5.fw.png", "media/DragonBoatFestival/6.fw.png",
            "media/DragonBoatFestival/7.fw.png");
