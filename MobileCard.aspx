...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MobileCard.aspx.cs" Inherits="BirthdayCard.MobileCard" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
    ...
    <style type="text/css">
        #app{
            ...
            background-image:url("background/12.fw.png")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("background/1.fw.png", "background/2.fw.png", "background/3.fw.png",
            "background/4.fw.png", "background/5.fw.png", "background/6.fw.png",
            "background/7.fw.png", "background/8.fw.png", "background/9.fw.png",
            "background/10.fw.png", "background/11.fw.png","background/12.fw.png");
