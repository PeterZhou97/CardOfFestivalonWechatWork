<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Double7thDayCard.aspx.cs" Inherits="BirthdayCard.Double7thDay" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
    ...
    <style type="text/css">
        #app{
            ...
            background-image:url("media/Double7thday/5.fw.png")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("media/Double7thday/1.fw.png", "media/Double7thday/2.fw.png",
            "media/Double7thday/3.fw.png", "media/Double7thday/4.fw.png",
            "media/Double7thday/5.fw.png", "media/Double7thday/6.fw.png",
            "media/Double7thday/7.fw.png");
