...
<script type="text/javascript" src="/js/jquery.min.js"></script>
    ...
    <style type="text/css">
        #app{
            ...
            background-image:url("media/laborday/2.png")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("media/laborday/1.png", "media/laborday/2.png", "media/laborday/3.png",
            "media/laborday/4.png", "media/laborday/5.png");
