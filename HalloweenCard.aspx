<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HalloweenCard.aspx.cs" Inherits="BirthdayCard.HalloweenCard" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
	...
	<title>瑞金医院卢湾分院万圣节贺卡推送</title>
    
    <style type="text/css">
        #app{
            border:2px solid #ff6a00; width:642px;height:1306px;  
            display:table;  
            background-position: center;
            background-size: cover; 
            background-repeat:no-repeat;
            background-image:url("media/Halloween/1.fw.png")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("media/Halloween/1.fw.png", "media/Halloween/2.fw.png",
            "media/Halloween/3.fw.png", "media/Halloween/4.fw.png",
            "media/Halloween/5.fw.png", "media/Halloween/6.fw.png",
            "media/Halloween/7.fw.png", "media/Halloween/8.fw.png");
   ...
   <script type="text/javascript">
     ...
     <script type="text/javascript">
         ...
         var imgnum = 8 //设置要显示的图片数，本例总共是55张。
