<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChildrenCard.aspx.cs" Inherits="BirthdayCard.ChildrenCard" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
    ...
    <style type="text/css">
        #app{
            ...
            background-image:url("media/childrenday/4.fw.png")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("media/childrenday/1.fw.png", "media/childrenday/2.fw.png",
                              "media/childrenday/3.fw.png", "media/childrenday/4.fw.png",
                              "media/childrenday/5.fw.png", "media/childrenday/6.fw.png");
