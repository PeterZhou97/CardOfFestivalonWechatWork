<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArmyDayCard.aspx.cs" Inherits="BirthdayCard.ArmyDayCard" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
    ...
    <style type="text/css">
        #app{
            ...
            background-image:url("media/armyday/7.png")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("media/armyday/1.png", "media/armyday/2.png", "media/armyday/3.png",
            "media/armyday/4.png", "media/armyday/5.png", "media/armyday/6.png",
            "media/armyday/7.png", "media/armyday/8.png");
