<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YouthDayCard.aspx.cs" Inherits="BirthdayCard.YouthDayCard" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
    ...
    <style type="text/css">
        #app{
            ...
            background-image:url("media/youthday/1.jpg")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("media/youthday/1.jpg", "media/youthday/2.jpg",
                            "media/youthday/3.jpg","media/youthday/4.jpg");
   ...
   <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        var imgnum = 4 //设置要显示的图片数，本例总共是55张。
