<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WomenDayCard.aspx.cs" Inherits="BirthdayCard.WomenDayCard" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
    ...
    <style type="text/css">
        #app{
            ...
            background-image:url("media/womenday/3.fw.png")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("media/womenday/1.fw.png", "media/womenday/2.fw.png",
            "media/womenday/3.fw.png", "media/womenday/4.fw.png",
            "media/womenday/5.fw.png", "media/womenday/6.fw.png", "media/womenday/7.fw.png");
   ...
   <script type="text/javascript">
     ...
     <script type="text/javascript">
         ...
         var imgnum = 7//设置要显示的图片数，本例总共是55张。
