<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeachersDayCard.aspx.cs" Inherits="BirthdayCard.TeachersDayCard" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
    ...
    <style type="text/css">
        #app{
            ...
            background-image:url("media/TeachersDay/2.fw.png")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        //定义一个存放照片位置的数组，可以放任意个，在这里放9个
        var myPix = new Array("media/TeachersDay/1.fw.png", "media/TeachersDay/2.fw.png",
                              "media/TeachersDay/3.fw.png", "media/TeachersDay/4.fw.png",
                              "media/TeachersDay/5.fw.png", "media/TeachersDay/6.fw.png",
                              "media/TeachersDay/7.fw.png", "media/TeachersDay/8.fw.png",
                              "media/TeachersDay/9.fw.png");
