<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NationalDayCard.aspx.cs" Inherits="BirthdayCard.NationalDayCard" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
	...
	<title>瑞金医院卢湾分院国庆节贺卡推送</title>
    
    <style type="text/css">
        #app{
            border:2px solid #ef3e09; width:640px;height:1300px;  
            display:table;  
            background-position: center;
            background-size: cover; 
            background-repeat:no-repeat;
            background-image:url("media/NationalDay/2.jpg")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("media/NationalDay/1.jpg", "media/NationalDay/2.jpg",
            "media/NationalDay/3.jpg", "media/NationalDay/4.jpg",
            "media/NationalDay/5.jpg", "media/NationalDay/6.jpg",
            "media/NationalDay/7.jpg", "media/NationalDay/8.jpg",
            "media/NationalDay/9.jpg", "media/NationalDay/10.jpg");
