<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartyBirthdayCard.aspx.cs" Inherits="BirthdayCard.PartyBirthdayCard" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
    ...
    <style type="text/css">
        #app{
            ...
            background-image:url("media/PartyBirthday/1.png")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("media/PartyBirthday/1.png", "media/PartyBirthday/2.png", "media/PartyBirthday/3.png",
            "media/PartyBirthday/4.png", "media/PartyBirthday/5.png", "media/PartyBirthday/6.png",
            "media/PartyBirthday/7.png");
