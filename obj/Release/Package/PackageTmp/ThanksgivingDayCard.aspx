<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThanksgivingDayCard.aspx.cs" Inherits="BirthdayCard.ThanksgivingDayCard" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
    ...
    <style type="text/css">
        #app{
            ...
            background-image:url("media/ThanksgivingDay/1.jpg")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("media/ThanksgivingDay/1.jpg", "media/ThanksgivingDay/2.jpg",
            "media/ThanksgivingDay/3.jpg", "media/ThanksgivingDay/4.jpg",
            "media/ThanksgivingDay/5.jpg");
