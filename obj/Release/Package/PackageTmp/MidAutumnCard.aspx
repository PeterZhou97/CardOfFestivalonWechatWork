<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MidAutumnCard.aspx.cs" Inherits="BirthdayCard.MidAutumnCard" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
    ...
    <style type="text/css">
        #app{
            ...
            background-image:url("media/MidAutumnFestival/5.fw.png")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("media/MidAutumnFestival/1.fw.png", "media/MidAutumnFestival/2.fw.png",
            "media/MidAutumnFestival/3.fw.png", "media/MidAutumnFestival/4.fw.png",
            "media/MidAutumnFestival/5.fw.png", "media/MidAutumnFestival/6.fw.png",
            "media/MidAutumnFestival/7.fw.png", "media/MidAutumnFestival/8.fw.png",
            "media/MidAutumnFestival/9.fw.png", "media/MidAutumnFestival/10.fw.png",
            "media/MidAutumnFestival/11.fw.png", "media/MidAutumnFestival/12.fw.png",
            "media/MidAutumnFestival/13.fw.png", "media/MidAutumnFestival/14.fw.png",
            "media/MidAutumnFestival/15.fw.png");
   ...
   <script type="text/javascript">
     ...
     <script type="text/javascript">
         ...
         var imgnum = 15 //设置要显示的图片数，本例总共是55张。
