<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewYearDayCard.aspx.cs" Inherits="BirthdayCard.NewYearDayCard" %>
...
<script type="text/javascript" src="/js/jquery.min.js"></script>
    ...
    <style type="text/css">
        #app{
            ...
            background-image:url("media/newyear/4.fw.png")
        }
        .word{
    ...
    <script type="text/javascript">
        ...
        var myPix = new Array("media/newyear/1.fw.png", "media/newyear/2.fw.png",
            "media/newyear/3.fw.png", "media/newyear/4.fw.png", "media/newyear/5.fw.png",
            "media/newyear/6.fw.png", "media/newyear/7.fw.png", "media/newyear/8.fw.png",
            "media/newyear/9.fw.png", "media/newyear/10.fw.png");
